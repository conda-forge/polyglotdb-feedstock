...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/polyglotdb-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/polyglotdb-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install polyglotdb
```
...
It is possible to list all of the versions of `polyglotdb` available on your platform:
...
```
pixi search polyglotdb --channel conda-forge
```
...
* [@lxy2304](https://github.com/lxy2304/)
* [@mmcauliffe](https://github.com/mmcauliffe/)
* [@msonderegger](https://github.com/msonderegger/)
